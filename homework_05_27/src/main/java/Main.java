...
/*
        Set копирую в List, что бы после отсортировать массив ориентируясь по позиции, которая была сохранена в TreeSet,
        так как позволяет сохранять данные по возрастанию автоматом. Что бы отсортировать коллекцию, беру в расчёт
        только первый элемент позиции, и по возрастающей сортирую всю коллекцию.
 */
